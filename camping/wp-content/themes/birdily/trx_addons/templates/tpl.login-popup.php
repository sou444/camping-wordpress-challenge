		...
		<ul class="trx_addons_tabs_titles"><?php // Attention! No CR or LF between tab titles!
			...
			?><li class="trx_addons_tabs_title trx_addons_tabs_title_register"<?php
				...
				<a href="<?php echo esc_url(trx_addons_get_hash_link('#trx_addons_register_content')); ?>">
					...
					<?php esc_html_e('Register', 'birdily'); ?>
				</a>
			</li><?php
		?></ul><?php
		...
		<div id="trx_addons_login_content" class="trx_addons_tabs_content trx_addons_login_content">
						...
						<div class="trx_addons_popup_form_field trx_addons_popup_form_field_login">
							...
							trx_addons_get_template_part(TRX_ADDONS_PLUGIN_SHORTCODES . 'form/tpl.form-field.php',
															...
															array(
																...
																'field_title' => esc_attr__('Login', 'birdily'),
																'field_placeholder' => esc_attr__('Login', 'birdily')
																)
														);
							?>
						</div>
						<div class="trx_addons_popup_form_field trx_addons_popup_form_field_password">
							...
							trx_addons_get_template_part(TRX_ADDONS_PLUGIN_SHORTCODES . 'form/tpl.form-field.php',
															...
															array(
																...
																'field_title' => esc_attr__('Password', 'birdily'),
																'field_placeholder' => esc_attr__('Password', 'birdily')
																)
														);
							?>
						</div>
						<div class="trx_addons_popup_form_field trx_addons_popup_form_field_remember">
							<a href="<?php echo esc_url(wp_lostpassword_url(get_permalink())); ?>" class="trx_addons_popup_form_field_forgot_password"><?php esc_html_e('Forgot password?', 'birdily'); ?></a>
							<input type="checkbox" value="forever" id="rememberme" name="rememberme"><label for="rememberme"> <?php esc_html_e('Remember me', 'birdily'); ?></label>
						</div>
						<div class="trx_addons_popup_form_field trx_addons_popup_form_field_submit">
							<input type="submit" class="submit_button" value="<?php esc_attr_e('Login', 'birdily'); ?>">
						</div>
			...
			<?php if (!empty($trx_addons_login_via_socials)) { ?>
				<div class="trx_addons_right_side">
					<div class="trx_addons_login_socials_title"><?php esc_html_e('or you can login using your favorite social profile!', 'birdily'); ?></div>
							...
							<div class="trx_addons_popup_form_field trx_addons_popup_form_field_email">
								...
								trx_addons_get_template_part(TRX_ADDONS_PLUGIN_SHORTCODES . 'form/tpl.form-field.php',
																...
																array(
																	...
																	'field_title' => esc_attr__('E-mail', 'birdily'),
																	'field_placeholder' => esc_attr__('E-mail', 'birdily')
																	)
															);
								?>
							</div>
						...
						<div class="trx_addons_right_side">
							...
							<div class="trx_addons_popup_form_field trx_addons_popup_form_field_password">
								...
								trx_addons_get_template_part(TRX_ADDONS_PLUGIN_SHORTCODES . 'form/tpl.form-field.php',
																...
																array(
																	...
																	'field_req'   => true,
																	'field_icon'  => 'trx_addons_icon-lock',
																	'field_title' => esc_attr__('Confirm Password', 'birdily'),
																	'field_placeholder' => esc_attr__('Confirm Password', 'birdily')
																	)
															);
								?>
							</div>
							<div class="trx_addons_popup_form_field trx_addons_popup_form_field_pwd_description">
								<?php esc_html_e('Minimum 4 characters', 'birdily'); ?>
							</div>
						</div>
							...
							if (!empty($trx_addons_privacy)) {
								?><div class="trx_addons_popup_form_field trx_addons_popup_form_field_agree">
									<input type="checkbox" value="1" id="i_agree_privacy_policy_registration" name="i_agree_privacy_policy"><label for="i_agree_privacy_policy_registration"> <?php echo wp_kses($trx_addons_privacy, 'birdily_kses_content'); ?></label>
								</div><?php
							}
							?>
		
						<div class="trx_addons_popup_form_field trx_addons_popup_form_field_submit">
							<input type="submit" class="submit_button" value="<?php esc_attr_e('Sign Up', 'birdily'); ?>"<?php
								if ( !empty($trx_addons_privacy) ) {
