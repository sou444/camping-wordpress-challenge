...
You can install it from the menu 'Appearance->Install plugins' or on the page 'Appearance->About Birdily'.
Please install and activate it before starting to use the theme Birdily.
...
Theme documentation is available on https://birdily.axiomthemes.com/doc/
...
2) Icons (css/font-icons/*.*)
   The icon set used in Birdily is Fontello.
