    ...
    <article class="wp-travel-default-article">
        ...
        <div class="wp-travel-article-image-wrap">
            <a href="<?php the_permalink(); ?>">
				<?php the_post_thumbnail( 'birdily-thumb-tourlist'); ?>
            </a>
			<?php if ( $enable_sale ) : ?>
        ...
        <div class="wp-travel-entry-content-wrapper">
            <div class="description-left">
                ...
                <header class="entry-header">
                    ...
                    <h4 class="entry-title">
                        <a href="<?php the_permalink(); ?>" rel="bookmark" title="<?php the_title_attribute( array( 'before' => __( 'Permalink to: ', 'birdily' ) ) ); ?>">
							<?php the_title(); ?>
                        </a>
                    </h4>
                </header><!-- .entry-header -->
				...
				<?php if ( wptravel_tab_show_in_menu( 'reviews' ) ) : ?>
                    ...
                    <span class="wp-travel-review-text"> (<?php printf( _n( '%d Review', '%d Reviews', $count, 'birdily' ), $count ); ?>)</span>
				<?php endif; ?>
                    ...
                    <div class="category-list-items">
							<span class="post-category">
								...
								<?php if ( is_array( $terms ) && count( $terms ) > 0 ) : ?>
									...
									<a href="<?php echo esc_url( $term_link, 'birdily' ); ?>" rel="tag">
									...
									<?php if ( count( $terms ) > 0 ) : ?>
										...
										<div class="sub-category-menu">
											<?php foreach ( $terms as $term ) : ?>
                                                ...
                                                <a href="<?php echo esc_url( $term_link, 'birdily' ); ?>">
													<?php echo esc_html( $term_name ); ?>
												</a>
											<?php endforeach; ?>
										</div>
            ...
            <div class="description-right">
                ...
                <div class="wp-travel-explore">
                    <a class="sc_button sc_button_default sc_button_size_small sc_button_icon_left sc_button_hover_slide_left" href="<?php the_permalink(); ?>"><?php esc_html_e( 'Explore', 'birdily' ); ?></a>
                </div>
            </div>
        </div>
    </article>
