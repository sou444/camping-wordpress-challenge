...
if ( ! function_exists( 'birdily_trx_addons_add_theme_vars' ) ) {
	add_filter( 'birdily_filter_add_theme_vars', 'birdily_trx_addons_add_theme_vars', 10, 2 );
	function birdily_trx_addons_add_theme_vars( $rez, $vars ) {
...
if ( ! function_exists( 'birdily_trx_addons_get_css' ) ) {
	add_filter( 'birdily_filter_get_css', 'birdily_trx_addons_get_css', 10, 2 );
	function birdily_trx_addons_get_css( $css, $args ) {

		if ( isset( $css['fonts'] ) && isset( $args['fonts'] ) ) {
			$fonts         = $args['fonts'];
			$css['fonts'] .= <<<CSS

.sc_skills_pie.sc_skills_compact_off .sc_skills_item_title, .sidebar .widget_title,
.sc_dishes_compact .sc_services_item_title,
.sc_services_iconed .sc_services_item_title, .trx_addons_tooltip:before, table td, .elementor-progress-percentage,
.trx_addons_audio_player.with_cover .audio_info .audio_author, .mejs-time .mejs-duration, .mejs-time .mejs-currenttime,
.mejs-container, .wpcf7-form-control-wrap.your-message textarea, .sc_form_field_textarea .sc_form_field_wrap textarea, .sc_team .sc_team_item_subtitle {
	{$fonts['p_font-family']}
}
.trx_addons_dropcap_style_1, .trx_addons_dropcap_style_2,
.sc_skills.sc_skills_pie .sc_skills_item_wrap .sc_skills_total, .sc_skills.sc_skills_counter .sc_skills_item_wrap .sc_skills_total,
.sc_price_item_title span, .sc_price_item_price .sc_price_item_price_value, .sc_button_vertical .sc_button_text .sc_button_title, .sc_price_item .sc_price_item_label,
.sc_widget_twitter .widget_title, .sc_testimonials [class*="column"] .sc_testimonials_item_author .sc_testimonials_item_author_title, .sc_price_item_price .sc_price_item_price_before, .sc_testimonials .sc_testimonials_item_author .sc_testimonials_item_author_title {
...
.sc_slider_controller_info, .trx_addons_list_parameters > li, .trx_addons_list > li, table th,
.trx_addons_audio_player.with_cover .audio_info .audio_caption, .sc_skills.sc_skills_pie .sc_skills_item_wrap .sc_skills_item_title,
.sc_skills.sc_skills_counter .sc_skills_item_wrap .sc_skills_title, .sc_price.sc_price_default .sc_price_item .sc_price_item_details,
.sc_action_item .sc_action_item_subtitle, .sc_action_item .sc_action_item_description, .sc_action_item.with_image .sc_action_item_inner .sc_action_item_link,
.sc_icons_item .sc_icons_item_description, .sc_testimonials_item_content, .sc_team .sc_team_item_header h4.sc_team_item_title,
.custom_list_1, .widget_twitter .widget_content .sc_twitter_item a, .widget_twitter .widget_content ul > li a, .top_panel .sc_layouts_item_details_line1, .top_panel .sc_layouts_item_details_line2, .footer_wrap .elementor-widget-text-editor .elementor-text-editor, .box_view_html {
...
.sc_button,
.sc_button_simple,
.sc_form button, .sc_blogger_item .more-link  {
...
.sc_promo_modern .sc_promo_link2, ul[class*="trx_addons_list_custom"] > li {
	{$fonts['button_font-family']}
}
...
.sc_button,
.sc_form button,
.sc_matches_item_pair .sc_matches_item_player .post_featured > img, .sc_blogger_item .more-link {
...
.sidebar .sidebar_inner .widget.widget_search .search-form:before,
.widget_area .widget_area_inner .widget.widget_search .search-form:before {
	color: {$colors['bg_color']};
}
...
.sc_widget_twitter .widget_twitter .widget_content ul > li:before {
	background-color: {$colors['bg_color']} !important;
}
.sc_widget_twitter .widget_twitter .widget_content ul > li:after {
...
.widget_twitter .widget_content .sc_twitter_item a:hover, .widget_twitter .widget_content ul > li a:hover {
	color: {$colors['text_link']};
}
...
.sc_blogger_item_header.entry-header .post_meta .post_meta_item.post_categories a:hover {
	color: {$colors['bg_color']};
	background-color: {$colors['text_link']};
}
.sc_blogger_item .more-link {
...
.trx_addons_popup_form input[type="text"], .trx_addons_popup_form input[type="password"] {
	border-color: {$colors['input_text']};
	color: {$colors['text_dark']};
}
.trx_addons_popup_form input[type="text"]:hover, .trx_addons_popup_form input[type="password"]:hover {
	border-color: {$colors['text_hover']};
}
.trx_addons_popup_form input[type="text"]:focus, .trx_addons_popup_form input[type="password"]:focus {
	border-color: {$colors['text_link']};
}
...
.sc_price.sc_price_default .sc_price_item.sc_price_item_default .sc_price_item_image .sc_price_item_title a {
	color: {$colors['alter_bd_hover']};
}
.sc_price_item:hover .sc_price_item_title,
.sc_price_item:hover .sc_price_item_title a,
.sc_price_item:hover .sc_price_item_info h3.sc_price_item_title span {
	color: {$colors['text_dark']};
}
...
h2.sc_testimonials_title.sc_item_title_style_default {
	color: {$colors['alter_bd_hover']};
}
...
.sc_testimonials_default .slider_outer_controls_outside .slider_controls_wrap > a:hover{
	border-color: {$colors['text_link']};
}
.sc_testimonials_default .slider_outer_controls_outside .slider_controls_wrap > a:hover:before {
	color: {$colors['text_link']};
}
...
/* Title */
.sc_title.sc_title_accent .sc_item_title.sc_title_title:after, .sc_title.sc_title_shadow .sc_item_title.sc_title_title:after {
	background-color: {$colors['extra_bg_color']};
}
.sc_title.sc_title_accent .sc_item_descr {
	color: {$colors['alter_link2']};
}
.sc_title.sc_title_alter .sc_item_title.sc_title_title, .sc_title.sc_title_alter .sc_item_subtitle.sc_title_subtitle {
	color: {$colors['extra_hover']};
}
...
.trx_addons_audio_player.with_cover .audio_info .audio_author, .trx_addons_audio_player .mejs-currenttime,
.trx_addons_audio_player .mejs-duration{
	color: {$colors['text']};
}
.trx_addons_audio_player.with_cover .audio_info .audio_caption {
	color: {$colors['text_dark']};
}
...
.sc_widget_audio .mejs-controls .mejs-button > button {
	background-color: {$colors['bg_color']} !important;
}
.single-post .sc_widget_audio .mejs-controls .mejs-button > button {
...
.sc_action_item.with_image .sc_action_item_inner .sc_action_item_link:hover {
	color: {$colors['text_link']};
}
/* Accordion */
...
/* Custom class */
.elementor-widget-trx_sc_button .sc_button.sc_button_simple, a.sc_button.sc_button_player {
	background-color: {$colors['alter_bg_color']} !important;
	color:{$colors['text_link']} !important;
}
a.sc_button.sc_button_player:hover {
	background-color: {$colors['text_link']} !important;
...
.sc_button.sc_button_vertical {
	background-color: {$colors['bg_color']} !important;
}
.sc_button_vertical .sc_button_text .sc_button_title, .sc_button.sc_button_vertical:after {
	color: {$colors['text_dark']};
}
.sc_button.sc_button_vertical:hover .sc_button_title, .sc_button.sc_button_vertical:hover:after {
	color:{$colors['text_link']};
}
.custom_list_1 ul li {
...
/* Custom counter */
.custom_class_counter_1 .sc_skills_counter .sc_skills_icon {
	color: {$colors['bg_color']};
	background: {$colors['text_link']};
}
/* Revolution slider */
