...
<script type="text/html" id="tmpl-esg-addon-item">
	<div id="esg_ale_{{ data.slug }}" class="esg_ale <# if (data.showinlist !== undefined && !data.showinlist) { #>esg-display-none<# } #>" data-ref="{{ data.slug }}">
		<div class="esg_alethumb" >
			...
			<# } else { #>
			<div class="esg_ale_pf esg_ale_free"><?php esc_html_e('Free', ESG_TEXTDOMAIN); ?></div>
			<# } #>
...
<div id="esg-missing-addons-dialog" class="esg-display-none">
	<div class="esg-missing-addons-title-wrapper">
		...
		<div class="esg-missing-addons-title"><?php esc_html_e('There is a problem with some of Essential Grid addons', ESG_TEXTDOMAIN); ?></div>
		<div class="esg-missing-addons-desc"><?php _e('These Essential Grid addons are deactivated or not installed:', ESG_TEXTDOMAIN); ?></div>
	</div>
	<div id="esg-missing-addons-content">
		...
		<div class="esg-missing-addons-btn-block">
			<div class="esg-missing-addons-desc"><?php _e('Press the button below to install & activate all addons required by your modules', ESG_TEXTDOMAIN); ?></div>
			<a id="esg-missing-addons-fix" class="esg-missing-addons-fix" href="javascript:void(0);"><?php esc_html_e('Fix All Addons', ESG_TEXTDOMAIN); ?></a>
		</div>
	</div>
</div>
